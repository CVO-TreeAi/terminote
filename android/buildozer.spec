...
# (str) Package name
package.name = terminote

# (str) Package domain (needed for android/ios packaging)
package.domain = ai.treeai

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,json,md,yaml,txt

# (list) List of inclusions using pattern matching
source.include_patterns = assets/*,data/*,core/*,tools/*,docs/*
...
# version.regex = __version__ = ['"]([^'"]*)['"](int, int, int), default=(0, 1, 0)
...
# use that parameter to provide a filename from where xml will be read
...
# 2) android.add_assets = file1.txt:icon/file1.txt,image.png:icon/image.png
#android.add_assets =
...
# You can set many archs, e.g. armeabi-v7a,arm64-v8a
...
# This option should be defined along with `universal-links`.
#ios.display-image-url =
